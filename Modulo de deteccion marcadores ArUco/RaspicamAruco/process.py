...
ret, mtx, dist, rvecs, tvecs= cv2.calibrateCamera(list_cb_3d_points, list_cb_2d_img_points, gray.shape[:: -1], None, No>print("Calibration Matrix:")
print(mtx)
